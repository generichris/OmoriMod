...
namespace OmoriMod.Content.NPCs.Town.Basil
{
    [AutoloadHead]
    public class Basil : ModNPC
    {
        ...
        {
            return new Terraria.GameContent.Profiles.DefaultNPCProfile("OmoriMod/Content/NPCs/Town/Basil/Basil", NPCHeadLoader.GetHeadSlot(HeadTexture));
        }
