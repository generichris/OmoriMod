...
{
    public class HappyGooberProjectile : ModSummonProjectile
    {
        ...
        private bool CheckActive(Player owner)
        {
            ...
            {
                owner.ClearBuff(ModContent.BuffType<HappyGooberBuff>());
                return false;
            }

            if (owner.HasBuff(ModContent.BuffType<HappyGooberBuff>()))
            {
            ...
            if (foundTarget && distanceFromTarget <= ShootRange && ShootTimer <= 0)
            {
                ...
                if (Main.myPlayer == Projectile.owner)
                {
                    ...
                    Projectile.NewProjectile(
                        ...
                        Projectile.Center,
                        shootVelocity,
                        ModContent.ProjectileType<HappyGooberBulletProjectile>(),
