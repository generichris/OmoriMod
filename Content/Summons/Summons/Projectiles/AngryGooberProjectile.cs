...
{
    public class AngryGooberProjectile : ModSummonProjectile
    {
        ...
        private bool CheckActive(Player owner)
        {
            ...
            {
                owner.ClearBuff(ModContent.BuffType<AngryGooberBuff>());
                return false;
            }

            if (owner.HasBuff(ModContent.BuffType<AngryGooberBuff>()))
            {
            ...
            if (foundTarget && distanceFromTarget <= ShootRange && ShootTimer <= 0)
            {
                ...
                if (Main.myPlayer == Projectile.owner)
                {
                    ...
                    Projectile.NewProjectile(
                        ...
                        Projectile.Center,
                        shootVelocity,
                        ModContent.ProjectileType<AngryGooberBulletProjectile>(),
