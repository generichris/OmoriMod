...
{
    public class FlyingSproutMoleProjectile : ModSummonProjectile
    {
        ...
        // Not too powerful - slower cooldown and shorter range than GShroober
        private const int ShootCooldown = 70;
        private const float ShootRange = 400f;
        ...
        public sealed override void SetDefaults()
        {
            ...
            Projectile.scale = 0.22f; // source art is 4 frames of 270x200px each, scale down to ~59x44

            Projectile.minionSlots = 1f;
            Projectile.penetrate = -1;

            Projectile.friendly = false; // deals damage via its bullets, not contact
        ...
        private bool CheckActive(Player owner)
        {
            ...
            {
                owner.ClearBuff(ModContent.BuffType<FlyingSproutMoleBuff>());
                return false;
            }

            if (owner.HasBuff(ModContent.BuffType<FlyingSproutMoleBuff>()))
            {
        ...
        public override void AI()
        {
            ...
            // Overrides the velocity-based rotation from PhantasmalVisuals() - the flying Sprout
            // Mole should always stay upright and only flip left/right, never tilt/spin sideways.
            ...
            if (foundTarget && distanceFromTarget <= ShootRange && ShootTimer <= 0)
            {
                ...
                if (Main.myPlayer == Projectile.owner)
                {
                    ...
                    Vector2 shootVelocity = direction * 8f;

                    Projectile.NewProjectile(
                        Projectile.GetSource_FromThis(),
                        Projectile.Center,
                        shootVelocity,
                        ModContent.ProjectileType<FlyingSproutMoleBulletProjectile>(),
        ...
        /// <summary>
        /// Keeps the minion floating near the player, same as GShroober.
        /// </summary>
